---
{"dg-publish":true,"permalink":"/explaining-the-generative-ai-tools-below/","noteIcon":"","dg-note-properties":{}}
---
...
____
**What is GPTZero ?**
GPTZero is an AI detection platform designed to analyze text and determine whether it was written by a human or generated by a large language model (like ChatGPT, Claude, or Gemini).
**How It Works**
Originally, the tool relied on metrics like perplexity (text randomness) and burstiness (variation in sentence structure). Modern versions use deep-learning models trained on millions of documents to evaluate text across multiple dimensions:  
- **Overall Classification**: Assigns a percentage score estimating the probability of AI involvement.
- **Sentence-Level Highlighting**: Color-codes specific sentences to pinpoint sections likely written or rewritten by AI. 
